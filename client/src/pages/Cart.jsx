    ...
    <Layout title="LiquorHub-cart">
      ...
      {cart.length > 0 ? (
        <div className="flex w-[100%] space-x-2 p-2">
          <div className="shadow dark:shadow-gray-900 rounded p-3 w-[68%] h-full px-5  ">
              ...
              {cart.map((item) => (
                ...
                >
                  ...
                  <div className="flex  w-[20%] items-center">
                    ...
                    >
                      <Trash2 size={17} className="text-gray-600 dark:text-gray-500" />
                    </Button>
                  </div>
                </div>
              ))}
          ...
          <div className="w-[32%] shadow dark:shadow-gray-900 rounded mx-2 p-4 space-y-4">
              ...
              {auth?.user?.address ? (
                <div className="flex  flex-col  w-[50%] space-y-2">
                  ...
                  <Button onClick={() => navigate("/dashboard/user/profile")}
                    className='dark:bg-[#161b22] dark:text-white hover:dark:bg-[#1c2128]'>
                    Change location?
                  </Button>
                  <Button onClick={() => handlePayment()}
                    className='dark:bg-[#161b22] dark:text-white hover:dark:bg-[#1c2128]'>Checkout</Button>
                </div>
              ) : auth.token ? (
                <Button onClick={() => navigate("/dashboard/user/profile")}>
                  Specify location?
